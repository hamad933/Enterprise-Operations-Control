...
const replacements = [
  ...
  ['Evidence / lineage','الدليل / التسلسل'],
  ['KPI → Deviation','المؤشر ← الانحراف'],
  ['Deviation → Decision','الانحراف ← القرار'],
  ['Task → Verification','المهمة ← التحقق'],
  ...
  ['Decision Authority','صلاحية القرار'],
  ...
  ['Decision','القرار'],
  ['Monitor','المتابعة'],
  ['Policy evaluator — synthetic','مقيّم سياسة الصلاحيات'],
  ...
  ['قراءات حساسات اصطناعية + سجل فحص','قراءات الحساسات + سجل الفحص'],
  ['قراءات خط اصطناعية','قراءات خط التغذية'],
  ['نتائج معايرة اصطناعية','نتائج المعايرة'],
  ['سجل مهام اصطناعي','سجل الأعمال'],
  ...
  ['تم تسجيل قرار اصطناعي داخل الذاكرة فقط؛ الإجراء التصحيحي والنتيجة يظلان منفصلين.','تم تسجيل القرار. يبقى الإجراء التصحيحي ومتابعة النتيجة مرحلتين مستقلتين.'],
  ['تمت محاكاة الاعتماد لهذه المراجعة فقط مع إبقاء سجل الأدوار والـ lineage.','تم تسجيل الاعتماد مع حفظ تسلسل الأدوار والمراجعة.'],
  ['تم فتح سياق المراجعة محليًا فقط؛ لا يوجد تنفيذ فعلي أو تكامل خارجي.','تم فتح سياق المراجعة للمستخدم الحالي.'],
...
const presentationTokens = [
  ...
  ['AUTHORITY_CONFLICT','تعارض الصلاحيات'],
